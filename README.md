...
> Answer: It doesnt require you to fully refresh the page each time something changes, and it supports really fleshed out animations and can handle them well.
